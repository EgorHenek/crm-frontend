  ...
  <v-layout>
    <v-flex>
      ...
      <v-container fluid grid-list-md>
        <v-data-iterator :items="task.attributes.history" content-tag="v-layout" row wrap>
          <v-flex slot="item" slot-scope="props">
            <v-card>
              ...
              <v-card-text>Создан: {{ props.item.created_at | dateFormat('dddd, Do MMMM YYYY, HH:mm')}}</v-card-text>
            </v-card>
          </v-flex>
        </v-data-iterator>
      </v-container>
